        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-cente">
                ...
                <div class="form-group mr-1 text-end">
                    <a class="btn btn-primary" href="{{ route('surat_domisili.create') }}">
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-secondary" href="{{ route('surat_domisili.show', $row) }}">
                                    <i class="bi bi-eye-fill"></i>
                                </a>
                                @if($row->status == 1)
                                <a class="btn btn-sm btn-info disabled" tabindex="-1" role="button" aria-disabled="true" href="{{ route('surat_domisili.edit', $row) }}">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('surat_domisili.destroy', $row) }}" method="POST" style="display: inline-block;"
                                ...
                                <a class="btn btn-sm btn-info" href="{{ route('surat_domisili.edit', $row) }}">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('surat_domisili.destroy', $row) }}" method="POST" style="display: inline-block;"
                                    onsubmit="return confirm('Hapus Data?')">
