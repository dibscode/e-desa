...
@section('content')
    ...
    @include('surat.sktm.include.nav')
    ...
    <div class="card">
            ...
            <div class="row">
                        ...
                        <tr>
                            <th>
                                <div class="btn-group float-end" role="group" aria-label="Basic example">
                                    @if($row->status == 1)
                                    <a class="btn btn-success btn-sm disabled" tabindex="-1" role="button" aria-disabled="true" href="{{ route('surat_keterangan_miskin.signature', $row) }}"><i class="bi bi-pen"></i> Signature Kades</a>
                                    @else
                                    <a class="btn btn-success btn-sm" href="{{ route('surat_keterangan_miskin.signature', $row) }}"><i class="bi bi-pen"></i> Signature Kades</a> 
                                    @endif
                                </div>
                            </th>
                        </tr>
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-end mb-2">
                        <a href="{{ route('surat_keterangan_miskin.cetak', $row->id) }}" target="_blank" class="btn-sm btn btn-secondary">
        ...
        <div class="card-footer">
            <a class="btn btn-danger" href="{{ route('surat_keterangan_miskin.index') }}"><i class="bi bi-box-arrow-in-left"></i> Kembali</a>
        </div>
    </div>
