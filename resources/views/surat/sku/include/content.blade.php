...
<p>Adalah benar-benar penduduk Desa Tarum Kecamatan Prajekan Kabupaten Bondowoso dan menurut keterangan bukti yang ada bahwa nama tersebut benar-benar mempunyai penghasilan :</p>
<table style="width: 100%; border-collapse: collapse;  margin-bottom: 20px;">
    <tbody>
        <tr>
            <td style="width: 30%; padding: 5px 0;">Jenis Usaha</td>
            <td style="padding: 5px 0;">: {{ $row->jenis_usaha }}</td>
            </tr>
        <tr>
            <td style="padding: 5px 0;">Lama Usaha</td>
            <td style="padding: 5px 0;">: {{ $row->lama_usaha }}</td>
        </tr>
    </tbody>
</table>
<p>Surat Keterangan ini diberikan kepada yang bersangkutan untuk melengkapi persyaratan.</p>
