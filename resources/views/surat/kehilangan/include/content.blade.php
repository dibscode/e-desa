...
<table style="width: 100%; border-collapse: collapse;  margin-bottom: 20px;">
    <tbody>
        ...
        <tr>
            <td style="padding: 5px 0;">Keperluan</td>
            <td style="padding: 5px 0;">: Mohon Pengantar Surat Kehilangan</td>
        </tr>
        <tr>
            <td style="padding: 5px 0;">Ket. Lain-lain</td>
            <td style="padding: 5px 0;">: Telah Kehilangan {{ $row->barang }} pada hari {{ $row->haritanggal }} di {{ $row->tempat }}</td>
        </tr>
        <tr>
            <td style="padding: 5px 0;">Berlaku Mulai</td>
            <td style="padding: 5px 0;">: {{ $row->berlaku }} sampai selesai pembuatan.</td>
        </tr>
    </tbody>
</table>
