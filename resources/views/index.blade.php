...
<head>
    ...
    <title>E-Desa</title>
    <link rel="shortcut icon" href="https://upload.wikimedia.org/wikipedia/commons/9/93/Lambang_Bondowoso.png"
        type="image/x-icon">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="api-url" content="{{ route('ai.chat') }}">
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col">
    ...
    <div id="chat-modal" class="fixed inset-0 z-50 hidden items-end sm:items-center justify-center px-4 py-6">
        ...
        <div
            class="relative w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden z-50">
            <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="text-xs text-gray-500 dark:text-gray-400">Tanyakan hal tentang layanan atau
                            fasilitas desa</div>
                    </div>
                </div>
                <div>
            ...
            <div class="px-4 py-3 border-t border-gray-200 dark:border-gray-700">
                <form id="chat-form" class="flex gap-2" onsubmit="return false;">
                    <input id="chat-input" type="text" placeholder="Ketik pertanyaan Anda tentang desa..."
                        class="flex-1 rounded-md border border-gray-300 dark:border-gray-700 px-3 py-2 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100"
                        autocomplete="off" />
                    <button id="chat-send"
                        class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Kirim</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        (function() {
            ...
            function appendMessage(text, who) {
                ...
                bubble.className = (who === 'user') ? 'inline-block bg-blue-600 text-white px-3 py-2 rounded-lg' :
                    'inline-block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 px-3 py-2 rounded-lg';
    ...
    try {
        ...
        const apiUrl = apiUrlMeta ? apiUrlMeta.getAttribute('content') : '/api/ai-chat';
        ...
        setTimeout(() => {
            removeTyping();
            const answer = 'Terima kasih, pertanyaan Anda: "' + text + '" telah diterima. (Kesalahan Jaringan Browser. Pastikan Anda online.)';
            appendMessage(answer, 'ai');
        }, 900);
    }
}
    ...
    <div class="p-6 bg-gray-50 dark:bg-gray-900">
                    ...
                    <div data-aos="fade-right" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="mb-4">
                            <h1
                                ...
                                <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Layanan</mark> <span
                                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Surat</span>
                            </h1>
                        ...
                        <ul class="space-y-4 text-left text-gray-500 dark:text-gray-400">
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pengajuan Surat
                            ...
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pengajuan Surat
                                    Pernyataan Penguasaan Tanah</span>
                            </li>
                        </ul>
                    </div>
                    <!-- Layanan Laporan -->
                    <div data-aos="fade-up" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="mb-4">
                            <h1
                                class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                                <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Layanan</mark> <span
                                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Lapor</span>
                            </h1>
                            <p class="mt-4 text-gray-700 dark:text-gray-300">
                                Lapor masalah di desa secara cepat. Unggah foto dan jelaskan lokasi/kejadian untuk
                                membantu penanganan.
                            </p>
                        </div>
                        <ul class="space-y-4 text-left text-gray-500 dark:text-gray-400">
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Laporkan
                                    Kerusakan Infrastruktur</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                    viewBox="0 0 20 20">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Laporan Kejadian
                                    Darurat</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pengaduan
                    ...
                    <div data-aos="fade-up" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="mb-4">
                            <h1
                                class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                                <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Layanan</mark> <span
                                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Pajak</span>
                            </h1>
                            <p class="mt-4 text-gray-700 dark:text-gray-300">
                        ...
                        <ul class="space-y-4 text-left text-gray-500 dark:text-gray-400">
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pembayaran Pajak
                                    Bumi & Bangunan</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Konsultasi Pajak
                                    Daerah</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Cetak SPPT &
                                    Bukti Bayar</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div data-aos="fade-up" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="mb-4">
                            <h1
                                class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                                <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Layanan</mark> <span
                                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Produk</span>
                            </h1>
                            <p class="mt-4 text-gray-700 dark:text-gray-300">
                        ...
                        <ul class="space-y-4 text-left text-gray-500 dark:text-gray-400">
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Produk Pangan &
                                    UMKM</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pesan Produk via
                                    WhatsApp</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Lihat Katalog
                                    Produk</span>
                            </li>
                        </ul>
                    </div>
        ...
        <section id="struktur-organisasi" class="bg-white dark:bg-gray-900 py-12">
            <div class="max-w-screen-xl px-4 mx-auto lg:px-6">
                <div class="mx-auto mb-8 max-w text-center">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Struktur
                        Organisasi E-Desa</h2>
                    <p class="mb-4 text-gray-500 dark:text-gray-400">Berikut adalah susunan perangkat E-Desa yang siap
                        melayani masyarakat dengan profesional dan transparan.</p>
                </div>
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div
                        class="flex flex-col items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-6 shadow hover:shadow-lg transition">
                        <div
...
>>>>>>> 451504beaaabc674839c88da0d6adb83d915b95b
        ...
        <section id="statistik-desa" class="py-10 bg-gray-50 dark:bg-gray-900">
            <div class="mx-auto mb-8 max-w text-center">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Statistik E-Desa
                </h2>
            ...
            <div class="max-w-screen-xl mx-auto px-4 lg:px-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                        <h5 class="my-4 text-lg font-semibold text-gray-900 dark:text-white text-center">Jumlah
                            Penduduk Berdasarkan Jenis Kelamin</h4>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center"
                        ...
                        <h4 class="my-4 text-lg font-semibold text-gray-900 dark:text-white text-center">Jumlah
                            Penduduk Berdasarkan Usia</h4>
                        <!-- Tempatkan chart di sini -->
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center"
                        ...
                        <h4 class="my-4 text-lg font-semibold text-gray-900 dark:text-white text-center">Jumlah
                            Penduduk Berdasarkan Mata Pencaharian</h4>
                        <!-- Tempatkan chart di sini -->
                        <div id="chart3" class="w-full h-32 flex flex-col items-center justify-center gap-2">
                            ...
                            <div class="flex flex-col items-center mt-2 text-xs">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="inline-block w-3 h-3 rounded-full bg-gray-400"></span>
                                    <span class="text-gray-700 dark:text-gray-200">Lain-lain/tidak tetap:
                                        <b>206</b></span>
                                </div>
                                <div class="flex items-center gap-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center"
                        ...
                        <h4 class="my-4 text-lg font-semibold text-gray-900 dark:text-white text-center">Jumlah tingkat
                            rata-rata pendidikan </h4>
                        <!-- Tempatkan chart di sini -->
            ...
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <a href="#" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/9/93/Lambang_Bondowoso.png"
                            class="h-8" alt="E-Desa Logo" />
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">E-Desa</span>
                    </a>
                    <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
                        © 2025 Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by
                        <a href="https://dibscode.com" class="text-blue-500">Adib Muhammad Zain</a>. All Rights
                        Reserved.</span>
                </div>
